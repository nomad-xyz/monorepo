...
export function tryLimitStrategyByName(name: string): CupsLimiterStrategy | RPPLimiterStrategy | undefined {
...
export function tryLimitStrategyByUrl(url: string): CupsLimiterStrategy | RPPLimiterStrategy | undefined {
