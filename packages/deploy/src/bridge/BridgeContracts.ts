...
export class SubstrateBridgeDeploy extends AbstractBridgeDeploy<config.SubstrateBridgeDeploymentInfo> {
  protected keys: ReadonlyArray<keyof config.SubstrateBridgeDeploymentInfo> = [
    'deployHeight',
  ];
  ...
  constructor(
    ...
    domain: string,
    data?: config.SubstrateBridgeDeploymentInfo,
  ) {
...
export class EthereumBridgeDeploy extends AbstractBridgeDeploy<config.EthereumBridgeDeploymentInfo> {
